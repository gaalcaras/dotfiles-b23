...
c.colors.statusbar.normal.bg = green
c.colors.statusbar.normal.fg = current_line
c.colors.statusbar.url.fg = dark_green
c.colors.statusbar.url.success.https.fg = dark_green
c.colors.statusbar.url.success.http.fg = dark_green
c.colors.statusbar.url.hover.fg = selection
c.colors.statusbar.progress.bg = dark_green
