...
" Mappings {{{1
" Sort tasks {{{2
if !hasmapto("<leader>l",'n')
    nnoremap <script> <silent> <buffer> <leader>l :sort<CR>
endif

if !hasmapto("<leader>l@",'n')
    nnoremap <script> <silent> <buffer> <leader>l@ :sort /.\{-}\ze@/ <CR>
endif
...
if !hasmapto("<leader>t",'n')
    nnoremap <script> <silent> <buffer> <leader>t :call TodoTxtPrioritizeIncrease()<CR>
endif

if !hasmapto("<leader>t",'v')
    vnoremap <script> <silent> <buffer> <leader>t :call TodoTxtPrioritizeIncrease()<CR>
endif

if !hasmapto("<leader>s",'n')
    nnoremap <script> <silent> <buffer> <leader>s :call TodoTxtPrioritizeDecrease()<CR>
endif

if !hasmapto("<leader>s",'v')
    vnoremap <script> <silent> <buffer> <leader>s :call TodoTxtPrioritizeDecrease()<CR>
endif
